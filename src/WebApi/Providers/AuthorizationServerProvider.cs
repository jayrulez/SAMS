...
namespace WebApi.Providers
{
    ...
    {
        internal UserManager _userManager;
        internal ApiClientManager _apiClientManager;
        ...
        public override Task ValidateClientAuthentication(OAuthValidateClientAuthenticationContext context)
        {
            ...
            var response = _apiClientManager.FindById(context.ClientId);
            ...
            if (client.ApiClientType == ApiClientType.Web)
            {
